...
export default function Search(){
  ...
  useEffect(()=>{const query=params.get("q");if(!query)return;setLoading(true);searchAll(query).then(r=>setData(r.data)).finally(()=>setLoading(false))},[params]);
